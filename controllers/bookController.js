...
exports.index = (req, res) => {
  async.parallel(
    ...
    (err, results) => { // so after all this couning functino will execute we can render index view with these attributes
      res.render("index", {
        title: "Local Library",
        error: err,
        data: results,
...
exports.book_delete_get = (req, res) => {
 ...
 Book.findById(req.params.id).exec(function (err, result){
    ...
    res.render('delete_book_form', {book_title:result.title})
 })
